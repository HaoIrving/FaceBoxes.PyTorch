...
from .lib.mobilev1 import Block as MBlock
...
class FaceBoxes(nn.Module):
  ...
  def __init__(self, phase, size, num_classes):
    ...
    self.mobile1 = MBlock(128, 128, 2)
    self.mobile2 = MBlock(128, 256, 1)

    self.mobile3 = MBlock(256, 128, 2)
    self.mobile4 = MBlock(128, 256, 1)
