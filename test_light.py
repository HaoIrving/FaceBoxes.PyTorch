...
parser.add_argument('-xcp', '--xcp', action="store_true", default=False, help=' ')
...
parser.add_argument('--eepoch', default="final", type=str, help=' ')
...
if __name__ == '__main__':
    ...
    if xcp:
        print('faceboxes_xception_xcp')
        from models_light.faceboxes_xception_xcp import FaceBoxes
