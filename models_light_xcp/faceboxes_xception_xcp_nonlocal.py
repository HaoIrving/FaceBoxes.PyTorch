...
class FaceBoxes(nn.Module):
  ...
  def __init__(self, phase, size, num_classes):
    ...
    repeat2 = 1
    self.conv3_1 = XBlock(128, 128, repeat2, 1, start_with_relu=True,grow_first=True)
    self.conv3_2 = XBlock(128, 256, repeat2, 2, start_with_relu=True,grow_first=True)
    self.nl4 = NONLocalBlock2D(256)

    self.conv4_1 = XBlock(256, 128, repeat2, 1, start_with_relu=True,grow_first=True)
    self.conv4_2 = XBlock(128, 256, repeat2, 2, start_with_relu=True,grow_first=True)
